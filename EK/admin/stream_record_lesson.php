...
<nav>
    ...
    <section class="dashboard">
        <div class="container dashboard__container">
            <button id="show__sidebar-btn" class="sidebar__toggle"><i class="uil uil-angle-right-b"></i>
            </button>

            <button id="show__sidebar-btn" class="sidebar__toggle"><i class="uil uil-angle-left-b"></i>
            </button>

            <aside>
                <ul>
                    <li>
                        <a href="add-lesson.php"><i class="uil uil-pen"></i>
                        <h5>Add Lesson</h5>
                        </a>
                    </li>
                    <li>
                        <a href="manage-posts.php" ><i class="uil uil-book"></i>
                        <h5>Manage Lesson</h5>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="stream_record_lesson.php" class="active"><i class="uil uil-video"></i>
            ...
            <main>
                ...
                <button id="startButton" onclick="startRecording()" class="btn btn-primary">Start Recording</button>
                <button id="stopButton" onclick="stopRecording()" class="btn btn-primary">Stop Recording</button>
                <div>
    ...
    <script>
        ...
        function handleRecordingStop() {
            ...
            downloadLink.innerHTML = 'Download Recorded Screen';
            document.getElementById('videoElement').parentNode.appendChild(downloadLink);
