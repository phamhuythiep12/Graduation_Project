                        ...
                        ?>
                            <?php
                                echo "
                                    ...
                                    <td><h5>".$row['user_firstname']."</h5></td>
                                    <td><h5>".$row['username']."</h5></td>
                                    <td><a href='edit-user.php?update=".$row['user_id']."' class='btn sm'><h5>Edit</h5></a></td>
                                    <td><a href='delete-user.php?delete=".$row['user_id']."' class='btn sm danger' id='delete' name='delete'><h5>Delete</h5></a></td>
                                    </tr>
                                ";
                            ?>
                        <?php
