...
<body>
        ...
        <div class="container dashboard__container">
            ...
            <aside>
                <ul>
                    ...
                    <li>
                        <a href="manage-posts.php" class="active"><i class="uil uil-book"></i>
                        <h5>Manage Lesson</h5>
                        </a>
                    </li>
                    <li>
                    ...
                    <tbody>
                        ...
                        ?>
                            <?php
                                echo "
                                    <tr>
                                    <td><h5>".$row['lesson_name']."</h5></td>
                                    <td><a href='edit-lesson.php?update=".$row['lesson_id']."' class='btn sm'><h5>Edit</h5></a></td>
                                    <td><a href='delete-lesson.php?delete=".$row['lesson_id']."' class='btn sm danger' id='delete' name='delete'><h5>Delete</h5></a></td>
                                    </tr>
                                ";
                            ?>
                        <?php
    ...
    <script src="manage-posts.js"></script>
</body>
</html>