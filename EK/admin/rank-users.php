...
// SQL query to get user_id and count of collections, ranked by count in descending order
$sql_ranking = "SELECT t1.user_id, COUNT(*) AS collection_count, t2.username
                FROM lesson_learned AS t1
                JOIN user_db AS t2 ON t1.user_id = t2.user_id
                GROUP BY t1.user_id
        ...
        <div class="container dashboard__container">
            ...
            <aside>
                <ul>
                    ...
                    <li>
                        <a href="rank-users.php" class="active"><i class="uil uil-users-alt"></i>
            ...
            <main>
                ...
                // Check if the query was successful
                    if ($result) {
                        ...
                        // Fetch rows and display the data in the table
