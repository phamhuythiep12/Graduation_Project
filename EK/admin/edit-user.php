    ...
    if (!empty($_FILES['user_avatar']['name'])) {
        ...
        if (in_array($avatar_ext, $allowed_ext)) {
            ...
            if ($avatar_size < 5000000) {
                ...
                $avatar_upload_path = 'uploadsUserAvatar/' . $avatar_new_name;
...
<body>
    ...
    <div class="container form__section-container">
        ...
        <input type="text" name="user_firstname" value="<?php echo $row['user_firstname']; ?>">
        <label><h5>Last Name</h5></label>
        <input type="text" name="user_lastname" value="<?php echo $row['user_lastname']; ?>">
        <label><h5>Username</h5></label>
        <input type="text" name="username" value="<?php echo $row['username']; ?>">
        <label><h5>Email</h5></label>
        <input type="email" name="user_email" value="<?php echo $row['user_email']; ?>">
        <label><h5>Password</h5></label>
        <input type="password" name="user_password" value="<?php echo $row['user_password']; ?>">
        <label><h5>Avatar</h5></label>
                                
        <img src="./uploadsUserAvatar/<?=$row['user_avatar']?>" id="imagePreview">
