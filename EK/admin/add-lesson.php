...
<body>
    ...
    <section class="form__section">
        <div class="container form__section-container">
            ...
            <form id="lessonForm" method="POST" action="add-lesson-config.php" enctype="multipart/form-data">
                <label for="lessonOverview"><h5>Lesson Name:</h5></label>
                <textarea id="lessonOverview" name="lesson_name"></textarea>
                ...
                <button type="submit" class="btn btn-primary" name="submit">Save Lesson</button>
            </form>
    ...
    <script src="add-lesson.js"></script>
</body>
</html>