...
<head>
    ...
    <title>English kids education course</title>
    ...
    <header id="header">
        <div class="container header__container">
            <div class="header_left">
                <h1>Start learning English now</h1>
                <p>Easy to understand, conformable with your children and easy to control your kids' progress</p>
                <a href="course.html" clsas="btn btn-primary">Get Started</a>
            </div>
        ...
        <div class="container courses__container">
            <article class="course">
                ...
                <div class="course-info">
                    <h4>The amazing alphabet</h4>
                    <p>
                        In this section, children will learn how to read and write the letters of the English alphabet through a song. Try to collect the flashcards as fast as you can!</p>
                    <a href="signin.php" class="btn btn-primary">Learn More</a>
                </div>
            ...
            <article class="course">
                ...
                <div class="course-info">
                    <h4>The animals</h4>
                    <p>In this part, children will learn how to read and write animals in real life through a video. Try to collect the flashcards as fast as you can!</p></p>
                    <a href="signin.php" class="btn btn-primary">Learn More</a>
                </div>
            ...
            <article class="course">
                ...
                <div class="course-info">
                    <h4>Kids cartoon story</h4>
                    <p>In this section, the kids will see short cartoons and remember to collect the flashcards as soon as possible!</p>
                    <a href="signin.php" class="btn btn-primary">Learn More</a>
                </div>
