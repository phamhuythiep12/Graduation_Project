    ...
    <section class="contact">
        <div class="container contact__container">
            <aside class="contact__aside">
                ...
                <h2>Contact Us</h2>
                <p>To get better and better</p>
                <ul class="contact__details">
                    <li>
                        <i class="uil uil-phone-times"></i>
                        <h5>+84 369 247 326</h5>
                    </li>
                    <li>
                        <i class="uil uil-envelope"></i>
                        <h5>phamhuythiep14@gmail.com</h5>
                    </li>
                    <li>
            ...
            <form action="https://formspree.io/f/mqkogpvk" method="POST" class="contact__form">
                <div class="form__name">
                    <input type="text" name="First Name" placeholder="First Name" required>
                    <input type="text" name="Last Name" placeholder="Last Name" required>
                </div>
                <input type="emai" name="Email Address" placeholder="Your Email Address" required>
