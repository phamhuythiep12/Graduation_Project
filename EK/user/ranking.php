<?php
    ...
    session_start();
    // SQL query to get user_id, count of collections, and username, ranked by count in descending order
...
<nav>
    ...
    if ($result) {
        ...
        echo "<table>
                <caption>Kid Ranking Page</caption>
                <tr>
                    <th>Rank</th>
                    <th>Username</th>
                    <th>Collections</th>
        ...
        while ($row_ranking = $result_ranking->fetch_assoc()) {
            $user_id = $row_ranking['user_id'];
            $username = $row_ranking['username'];
            $collection_count = $row_ranking['collection_count'];
