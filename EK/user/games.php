        ...
        <div class="container courses__container">
            <article class="course">
                <div class="course__image">
                    <img src="../admin/images/guesstheword.png" alt="">
                </div>
                <div class="course-info">
                    <h4>Guess the word</h4>
                    <p>Write the word with the image appears in the quests</p>
                    <a href="guess_the_word_game.php" class="btn btn-primary">Play</a>
                </div>
            ...
            <article class="course">
                <div class="course__image">
                    <img src="../admin/images/hangman.png" alt="">
                </div>
                <div class="course-info">
                    <h4>Hang Man</h4>
                    <p>See the image and guess to save stickman</p></p>
                    <a href="hangman_game.php" class="btn btn-primary">Play</a>
                </div>
            ...
            <article class="course">
                <div class="course__image">
                    <img src="../admin/images/word_matching.jpg" alt="">
                </div>
                <div class="course-info">
                    <h4>Word matching</h4>
                    <p>Match the image with word display and win </p>
                    <a href="word_matching_game.php" class="btn btn-primary">Play</a>
                </div>
