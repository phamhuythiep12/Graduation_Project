      ...
      if(isset($_POST['submit'])){
        ...
        if(mysqli_num_rows($select)>0){
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
            // Check the user's credentials (e.g. username and password) here
            // ...

            // If the user's credentials are valid, set the session variable with the username
            $_SESSION["username"] = $username; // Replace $username with the actual username value
            header("Location: course.php"); // Redirect to the welcome page
    ...
    <section class="form__section">
        <div class="container form__section-container">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <small>Dont's have account? <a href="signup.php">Sign Up</a></small>
            </form>
        </div>
    </section>
